...
compile gen.py pypy3

samplegroup
limits maxN=10 maxQ=10
sample 1

group 1-small-valid 10 # 1
...
group 4-medium-random 10 # 4
limits maxN=7000 maxQ=120000
include_group 2-small-random
include_group 3-medium-valid
tc random-medium gen N=7000 Q=70000 method=random only_valid=0 seed=3 # 4a-47

group 5-big-valid-easy 10 # 5
...
group 6-big-valid 30 # 6
limits maxN=50000 maxQ=70000 valid=yes
include_group 5-big-valid-easy
...
group 7-big-random 10 # 7
limits maxN=50000 maxQ=70000
include_group 2-small-random
include_group 6-big-valid
tc random-valid-medium
tc random-medium
